...
public class CommonPingAuthCallBackURL extends AsyncTask<String, Void, Void>{
	...
	public CommonPingAuthCallBackURL(String string, Context _context) {
		loadingSection =string;
		context =_context;
		
		callback=(PingCallback) context;
	}
