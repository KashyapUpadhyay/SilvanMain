...
public class MoodListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(section.toLowerCase().contains("global")) {
            if(selectedMoodPos==position){
                holder.img_list_icon.setImageResource(R.drawable.globalroom);
                holder.txt_list.setTextColor(context.getResources().getColor(R.color.white));
            }else{
                holder.img_list_icon.setImageResource(R.drawable.globalroom_menu);
                holder.txt_list.setTextColor(context.getResources().getColor(R.color.unselected));
            }
        }
